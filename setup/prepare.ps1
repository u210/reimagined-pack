...
$clientPattern = '^(AmbientSounds|AsyncParticles|auto_third_person|BadOptimizations|blur-|cherishedworlds|chloride-|colorwheel-|continuity-|controllable-|Controlling-|DistantHorizons-|entity_model_features|entity_texture_features|entityculling-|EuphoriaPatcher-|extrasounds-|ExtremeSoundMuffler-|fancymenu_|fancytoasts-|fast-ip-ping-|ImmediatelyFast-|ImmersiveUI-|iris-|item_descriptions-|ItemPhysicLite_|Ixeris-|lambdynamiclights-|localmodtranslator-|melody_|modtabs-|moreculling-|MouseTweaks-|music-and-melody-|nomusicpause-|Not Enough Recipe Book|notenoughanimations-|nowheel-|OverflowingBars-|particle_core-|particular-|punchy-|pv-addon-soundphysics-|sodium-|sound-physics-remastered-|super_resolution-|Too Many Entities |tooltipoverhaul-|world-host-|xaerominimap-|xaeroworldmap-|hidetab-)'
